...
for_move_data, for_speed, for_hp, against_move_data, against_speed, against_hp = stimulation_basedon_moves(details, type_chart, moves, "Greninja", "Lucario")
# if not "for_move_data" in st.session_state:
#     st.session_state["for_move_data"] = for_move_data
# if not "against_move_data" in st.session_state:
#     st.session_state["against_move_data"] = against_move_data
# if not "for_hp" and "for_speed" in st.session_state:
#     st.session_state["for_hp"] = for_hp
#     st.session_state["for_spees"] = for_speed
# if not "against_hp" and "against_speed" in st.session_state:
#     st.session_state["against_hp"] = against_hp
#     st.session_state["against_speed"] = against_speed
# st.write(st.session_state["for_move_data"], st.session_state["against_move_data"])
